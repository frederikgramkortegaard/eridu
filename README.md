...
Testing and benchmarking was performed using Python based frameworks written from scratch as shown in sections 6. and 8. of the thesis in which a formal description of Eridu can also be found.
